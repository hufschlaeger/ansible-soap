...
try:
    ...
    from ansible_collections.hufschlaeger.soap_client.plugins.module_utils.soap_module.application.use_cases.batch_send_use_case import BatchSendUseCase, BatchSendCommand
    ...
    try:
        ...
        from ansible.module_utils.soap_module.application.use_cases.batch_send_use_case import BatchSendUseCase, BatchSendCommand
...
def run_module():
    ...
    try:
        ...
        for req_params in module.params['requests']:
            ...
            if not is_valid:
                module.fail_json(
                    msg=f'Request validation failed: {error}',
                    **result
                )
